...
export default function Home() {
    return (
        <>
            <NextSeo
                title="delicious.ee"
                description="Welocme to delicious.ee - delicious, delicieux, from Late Latin dēliciōsus "
                defaultTitle="delicious.ee"
                openGraph={{
                    url: "https://www.delicious.ee/",
                    title: "delicious.ee",
                    description:
                        "Welocme to delicious.ee - delicious, delicieux, from Late Latin dēliciōsus "
                }}
                additionalMetaTags={[
                    {
                        property: "keywords",
